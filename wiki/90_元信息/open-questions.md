...
8. **H.E.S.S. coherence loss 与 multiple-star modeling 的权重**：Zmija et al. 2023 中 Nunki 的 fitted zero-baseline constant 低于 expected coherence time，Shaula / Acrux 又是 multiple systems；后续比较 H.E.S.S.、MAGIC-SII、VERITAS 时，需要区分 instrument coherence loss、filter incidence-angle effects、offline correlator limitation 和 astrophysical source complexity。
