...
| --- | --- | --- | --- | --- |
| `SJ-GEOM-001` | patch-observer angular separation | `models/structured_jet/angular.py::angular_separation` | `cpp/src/angular_kernel.cpp::angular_separation` | `structured_jet_afterglow_program_check.md` |
| `SJ-DOPPLER-001` | Doppler factor | `models/structured_jet/angular.py::doppler_factor` | `cpp/src/angular_kernel.cpp::doppler_factor` | `structured_jet_afterglow_program_check.md` |
| `SJ-PROFILE-TOPHAT-001` | top-hat angular energy profile | `models/structured_jet/angular.py::top_hat_energy_per_sr` | future | `structured_jet_afterglow_program_check.md` |
| `SJ-PROFILE-GAUSS-001` | Gaussian angular energy profile | `models/structured_jet/angular.py::gaussian_energy_per_sr` | `cpp/src/angular_kernel.cpp::gaussian_energy_per_sr` | `structured_jet_afterglow_program_check.md` |
| `SJ-PROFILE-PL-001` | smooth power-law angular energy profile | `models/structured_jet/angular.py::powerlaw_energy_per_sr` | `cpp/src/angular_kernel.cpp::powerlaw_energy_per_sr` | `structured_jet_afterglow_program_check.md` |
| `SJ-INTEGRAL-001` | Doppler-weighted angular toy integral | `models/structured_jet/angular.py::integrate_weighted_energy` | `cpp/src/angular_kernel.cpp::integrate_gaussian_weighted_energy` | `structured_jet_afterglow_program_check.md` |
| `SJ-FLUX-TOY-001` | patch-level weighted synchrotron flux toy | `models/structured_jet/angular.py::integrate_weighted_flux` | future spectral/angular batch kernel | `structured_jet_afterglow_program_check.md` |
