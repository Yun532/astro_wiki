...
tags: [GRB 221009A, model-comparison, structured-jet, LHAASO, forward-shock, radio]
source_count: 2
confidence: medium
related:
...
- LHAASO narrow jet / structured jet core 与 Laskar et al. forward-shock / wind-like medium 是否需要同一个 jet structure 才能同时解释 TeV 和 radio-to-GeV afterglow？
