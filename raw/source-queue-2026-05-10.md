---
title: Autonomous ingest source queue 2026-05-10
source_type: source-queue
status: active
last_updated: 2026-05-14
---

# Autonomous ingest source queue 2026-05-10

## Batch A: GRB 221009A continuation
...
| A5 | A structured jet explains the extreme GRB 221009A | arXiv:2302.07906; DOI: 10.1126/sciadv.adi1405 | structured-jet modeling paper | 已 ingest：补充前三个月多波段余辉、X-ray t^-1.66 decay 和 shallow structured jet 解释 | `模型解释.md`, `光变曲线.md`, `grb-221009a-model-comparison.md`, `open-questions.md` |
...
| B2 | A common origin for cosmic explosions inferred from calorimetry of GRB 030329 | arXiv:astro-ph/0308187; DOI: 10.1038/nature01998 | event/model paper | 已 ingest：补充 GRB 030329 radio calorimetry、5° narrow jet / 17° wide jet 事件级 two-component 案例 | `two-component-jet.md`, `two-component-grb-models.md` |
| B3 | Broadband observations of the naked-eye gamma-ray burst GRB 080319B | arXiv:0805.1557; DOI: 10.1038/nature07270 | event/model paper | 已 ingest：补充 naked-eye prompt optical、optical/gamma mismatch、0.2° narrow core / 4° wide component 案例 | `two-component-jet.md`, `two-component-grb-models.md`, `wiki_textbook/grb-afterglow/来源脉络.md` |
| B4 | The Structure of Gamma Ray Burst Jets | arXiv:2206.11088 | review | 已 ingest：建立 top-hat / structured / two-component / quasi-universal 喷流谱系，补充 angular profile 和 off-axis afterglow 判据 | `two-component-jet.md`, `afterglow-dynamics.md`, `术语表.md`, `wiki_textbook/grb-afterglow/公式索引.md` |

## Batch C: IACT principles and reconstruction
...
| D3 | Optical intensity interferometry observations using the MAGIC IACTs | arXiv:1911.06029; DOI: 10.1093/mnras/stz3171 | demonstration paper | 已 ingest：补充 MAGIC 双 17 m IACT correlation detection、central-pixel analog setup、filter / duty-cycle / systematics caveats | `cherenkov-telescope-interferometry.md` |
| D4 | Performance and first measurements of the MAGIC Stellar Intensity Interferometer | arXiv:2402.04755; DOI: 10.1093/mnras/stae697 | instrument/performance paper | 已 ingest：补充 MAGIC-SII upgraded system、real-time GPU correlator、22 个 stellar diameter measurements、systematics budget 和 LST / CTAO extension caveats | `cherenkov-telescope-interferometry.md` |
| D5 | First Intensity Interferometry Measurements with the H.E.S.S. Telescopes | arXiv:2312.08015; DOI: 10.1093/mnras/stad3676 | demonstration paper | 已 ingest：补充 H.E.S.S. Phase I telescope SII setup、zero-baseline / cross-correlation channels、motorized tracking correction、Shaula / Nunki / Acrux measurements 和 coherence-loss caveats | `cherenkov-telescope-interferometry.md` |
